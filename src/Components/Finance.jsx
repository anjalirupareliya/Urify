  ...
  return (
    <div className="bg-white text-black font-sans">
      ...
      <section className="flex flex-col lg:flex-row items-center px-8 py-16 space-y-10 lg:space-y-0 lg:space-x-10">
        ...
        {/* Right Content */}
        <div className='flex'>
          <img src={iphone1} alt="" className="w-45 absolute left-[1100px] bottom-[0px] z-10" />
          <img src={iphone2} alt="" className="w-65 absolute left-[1000px] bottom-[50px] z-20" />
          <img src={iphone3} alt="" className="w-90 absolute left-[900px] bottom-[90px] z-30" />
